...
const PERMISSION_DESCRIPTIONS: Record<string, string> = {
  ...
  'expenses.view': 'See what the business has spent on things other than stock',
  'expenses.create': 'Record an expense',
  'expenses.manage_categories': 'Decide which accounting account each kind of expense lands in',
  ...
  'tax.view': 'View the business tax configuration',
  'tax.manage': 'Create, edit and retire taxes, and set the pricing mode and default tax',
};
